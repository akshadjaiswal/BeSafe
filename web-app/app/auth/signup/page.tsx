  ...
  return (
    ...
    >
      ...
      <motion.div variants={staggerItem} className="text-center mb-8">
        <h1 className="text-3xl font-bold text-surface-on mb-2">Create Account</h1>
        <p className="text-surface-on-variant">
          Start your safe commute journey
        </p>
      </motion.div>
      ...
      {/* Form */}
      <motion.form variants={staggerItem} onSubmit={handleSignup} className="space-y-4">
